...
interface FAQSectionProps {
  initialFAQ?: Awaited<ReturnType<typeof import("@/lib/services/content.service").getFAQ>>;
}

export function FAQSection({ initialFAQ }: FAQSectionProps = {}) {
  const { data: faqs = initialFAQ ?? [] } = useFAQ();
